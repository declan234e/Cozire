    ...
    Game: { // Our overrides
        UpdateMenu: () => {
            ...
            if (Game.onMenu == 'prefs') {
                ...
                if (typeof CM === 'undefined' || Cozire.cookieMonsterLoaded) fragment.appendChild(Cozire.Menu.actionButton('unloadCrustulum','Unload Cozire','Unloads Cozire and disabled all of it\'s features.', Cozire.Actions.unloadCrustulum));
...
// Alternatively, you can set CrustulumInit to false to prevent the Init and set up your plugins after loading the script, remember to call `Cozire.Init()` afterwards.
if (typeof CrustulumInit === 'undefined' || CrustulumInit) Cozire.Init();
